...
Geometry::IDetector_const_sptr LeanElasticPeak::getDetector() const {
  throw Exception::NotImplementedError("LeanElasticPeak::getDetector(): Has no detector ID");
}
...
void LeanElasticPeak::setSamplePos(double, double, double) {
  throw Exception::NotImplementedError("LeanElasticPeak has no sample information");
}
