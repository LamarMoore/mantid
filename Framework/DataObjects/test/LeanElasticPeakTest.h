...
public:
  ...
  void test_default_constructor() {
    ...
    TS_ASSERT_THROWS(p.getDetectorPosition(), const Exception::NotImplementedError &)
    TS_ASSERT_THROWS(p.getDetectorPositionNoCheck(), const Exception::NotImplementedError &)
  ...
  void test_Peak_to_LeanElasticPeak_through_IPeak() {
    ...
    TS_ASSERT_THROWS(leanpeak.getDetector(), const Exception::NotImplementedError &)
  }
};
