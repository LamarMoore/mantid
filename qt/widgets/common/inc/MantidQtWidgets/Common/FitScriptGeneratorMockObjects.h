...
public:
  ...
  MOCK_METHOD7(openEditLocalParameterDialog,
               void(std::string const &parameter,
...
public:
  ...
  MOCK_CONST_METHOD2(getEquivalentFunctionIndexForDomain,
                     std::string(MantidQt::MantidWidgets::FitDomainIndex,
                                 std::string const &functionIndex));
  MOCK_CONST_METHOD4(
  ...
  MOCK_CONST_METHOD2(hasParameter,
                     bool(MantidQt::MantidWidgets::FitDomainIndex domainIndex,
                          std::string const &parameter));
  ...
  MOCK_METHOD3(setParameterFixed,
               void(MantidQt::MantidWidgets::FitDomainIndex domainIndex,
                    std::string const &fullParameter, bool fix));
  MOCK_METHOD3(setParameterTie,
               void(MantidQt::MantidWidgets::FitDomainIndex domainIndex,
                    std::string const &fullParameter, std::string const &tie));
  MOCK_METHOD3(setParameterConstraint,
               void(MantidQt::MantidWidgets::FitDomainIndex domainIndex,
                    std::string const &fullParameter,
                    std::string const &constraint));
  ...
  MOCK_CONST_METHOD2(getParameterValue,
                     double(MantidQt::MantidWidgets::FitDomainIndex domainIndex,
                            std::string const &fullParameter));
