...
public:
  ...
  test_that_getEquivalentFunctionIndexForDomain_will_return_the_correct_function_index_for_simultaneous_mode() {
    ...
    TS_ASSERT_EQUALS(m_model->getEquivalentFunctionIndexForDomain(
                         "Name2", m_wsIndex, "f0.f0."),
                     "f1.f0.");
    TS_ASSERT_EQUALS(m_model->getEquivalentFunctionIndexForDomain(
                         FitDomainIndex(1), "f0.f0."),
                     "f1.f0.");
  }
  ...
  test_that_getEquivalentFunctionIndexForDomain_just_returns_the_index_if_it_is_an_empty_string() {
    ...
    TS_ASSERT_EQUALS(
        ...
        "");
    TS_ASSERT_EQUALS(
        m_model->getEquivalentFunctionIndexForDomain(FitDomainIndex(1), ""),
        "");
  }
  ...
  test_that_getEquivalentFunctionIndexForDomain_just_returns_the_index_if_it_is_in_sequential_mode() {
    ...
    TS_ASSERT_EQUALS(m_model->getEquivalentFunctionIndexForDomain(
                     ...
                     "f0.");
    TS_ASSERT_EQUALS(
        m_model->getEquivalentFunctionIndexForDomain(FitDomainIndex(0), "f0."),
        "f0.");
  }
  ...
  void
  test_that_getAdjustedFunctionIndex_will_return_the_same_parameter_for_sequential_mode() {
    setup_sequential_fit_with_no_ties();
    TS_ASSERT_EQUALS(m_model->getAdjustedFunctionIndex("f0.A0"), "f0.A0");
  }

  void
  test_that_getAdjustedFunctionIndex_will_return_the_same_string_for_an_empty_string_or_number() {
    setup_sequential_fit_with_no_ties();
  ...
  void
  test_that_getAdjustedFunctionIndex_will_remove_the_top_function_index_for_simultaneous_mode() {
    setup_simultaneous_fit_with_no_ties();
    TS_ASSERT_EQUALS(m_model->getAdjustedFunctionIndex("f1.f0.A0"), "f0.A0");
  }

  void
  test_that_getFullParameter_will_return_the_same_parameter_if_in_sequential_mode() {
    setup_sequential_fit_with_no_ties();
    TS_ASSERT_EQUALS(m_model->getFullParameter(FitDomainIndex(1), "f0.A0"),
                     "f0.A0");
  }

  void
  test_that_getFullParameter_will_return_the_full_parameter_if_in_simultaneous_mode() {
    setup_simultaneous_fit_with_no_ties();
    TS_ASSERT_EQUALS(m_model->getFullParameter(FitDomainIndex(1), "f0.A0"),
                     "f1.f0.A0");
  }
  ...
  void
  test_that_getFullTie_will_return_the_same_tie_if_it_is_empty_or_a_number() {
    setup_simultaneous_fit_with_no_ties();
  ...
  void test_that_getFullTie_will_return_the_full_tie_if_in_simultaneous_mode() {
    setup_simultaneous_fit_with_no_ties();
    TS_ASSERT_EQUALS(m_model->getFullTie(FitDomainIndex(1), "f0.A0"),
                     "f1.f0.A0");
  }
  ...
  void
  test_that_hasParameter_returns_true_if_the_parameter_exists_when_in_sequential_mode() {
    setup_sequential_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());
  ...
  void
  test_that_hasParameter_returns_false_if_the_parameter_does_not_exist_when_in_sequential_mode() {
    setup_sequential_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());
  ...
  void
  test_that_hasParameter_returns_true_if_the_parameter_exists_when_in_simultaneous_mode() {
    setup_simultaneous_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());
  ...
  void
  test_that_hasParameter_returns_false_if_the_parameter_does_not_exist_when_in_simultaneous_mode() {
    setup_simultaneous_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());
  ...
  void
  test_that_setParameterValue_sets_the_parameter_if_the_parameter_exists_when_in_sequential_mode() {
    double newValue = 5.0;
    setup_sequential_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());
    ...
    TS_ASSERT_EQUALS(m_model->getParameterValue(FitDomainIndex(0), "f0.A0"),
                     newValue);
  }
  ...
  test_that_setParameterValue_will_not_throw_if_the_parameter_if_the_parameter_does_not_exist_when_in_sequential_mode() {
    ...
    TS_ASSERT_THROWS_NOTHING(
        m_model->setParameterValue(FitDomainIndex(0), "f0.BadParam", newValue));
  }

  void
  test_that_setParameterValue_sets_the_parameter_if_the_parameter_exists_when_in_simultaneous_mode() {
    double newValue = 5.0;
    setup_simultaneous_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());
    ...
    TS_ASSERT_EQUALS(m_model->getParameterValue(FitDomainIndex(0), "f0.f0.A0"),
                     newValue);
  }

  void
  test_that_setParameterValue_will_not_throw_if_the_parameter_does_not_exist_when_in_simultaneous_mode() {
    double newValue = 5.0;
    setup_simultaneous_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());
    ...
    TS_ASSERT_THROWS_NOTHING(m_model->setParameterValue(
        FitDomainIndex(0), "f0.f0.BadParam", newValue));
  }

  void
  test_that_setParameterFixed_sets_the_parameter_as_fixed_if_the_parameter_exists_when_in_sequential_mode() {
  ...
  test_that_setParameterFixed_will_throw_if_the_parameter_if_the_parameter_does_not_exist_when_in_sequential_mode() {
    ...
    TS_ASSERT_THROWS(
        m_model->setParameterFixed(FitDomainIndex(0), "f0.BadParam", true),
        std::runtime_error const &);
  }

  void
  test_that_setParameterFixed_sets_the_parameter_if_the_parameter_exists_when_in_simultaneous_mode() {
  ...
  void
  test_that_setParameterFixed_will_throw_if_the_parameter_does_not_exist_when_in_simultaneous_mode() {
    setup_simultaneous_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());

    TS_ASSERT_THROWS(
        m_model->setParameterFixed(FitDomainIndex(0), "f0.f0.BadParam", true),
        std::runtime_error const &);
  }

  void
  test_that_setParameterTie_sets_the_parameter_tie_if_the_parameter_exists_when_in_sequential_mode() {
    std::string const parameter("f0.A0");
  ...
  void
  test_that_setParameterTie_will_not_throw_if_the_parameter_does_not_exist_when_in_sequential_mode() {
    setup_sequential_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());

    TS_ASSERT_THROWS_NOTHING(m_model->setParameterTie(
        FitDomainIndex(0), "f0.BadParam", "f1.Height"));
  }

  void
  test_that_setParameterTie_sets_the_parameter_tie_if_the_parameter_exists_when_in_simultaneous_mode() {
    std::string const parameter("f0.f0.A0");
    std::string const tie("f1.Height");
    setup_simultaneous_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());
  ...
  void
  test_that_setParameterTie_will_throw_if_the_parameter_does_not_exist_when_in_simultaneous_mode() {
    setup_simultaneous_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());

    TS_ASSERT_THROWS_NOTHING(m_model->setParameterTie(
        FitDomainIndex(0), "f0.f0.BadParam", "f0.f1.Height"));
  }
  ...
  test_that_setParameterConstraint_sets_the_parameter_constraint_if_the_parameter_exists_when_in_sequential_mode() {
    ...
    TS_ASSERT_EQUALS(
        m_model->getParameterConstraint(FitDomainIndex(0), parameter),
        "0<A0<1");
  ...
  void
  test_that_setParameterConstraint_will_not_throw_if_the_parameter_does_not_exist_when_in_sequential_mode() {
    std::string const constraint("0<f0.BadParam<1");
    setup_sequential_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());

    TS_ASSERT_THROWS_NOTHING(m_model->setParameterConstraint(
        FitDomainIndex(0), "f0.BadParam", constraint));
  }
  ...
  void
  test_that_setParameterConstraint_will_throw_if_the_parameter_does_not_exist_when_in_simultaneous_mode() {
    setup_simultaneous_fit_with_no_ties();
    m_model->addFunction(m_wsName, m_wsIndex, m_expDecay->asString());

    TS_ASSERT_THROWS_NOTHING(m_model->setParameterConstraint(
        FitDomainIndex(0), "f0.f0.BadParam", "0<f0.BadParam<1"));
  }
